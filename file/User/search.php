...
?>
    <div align="center">
        ...
        <form method ="post" action="">
                ...
                <tbody>
                    <div class="cp_ipselect">
                        <select name="prefecture" class="cp_sl06" required>
                            ...
                            <option value="25">滋賀県</option><option value="26">京都府</option><option value="https://tb-220376.tech-base.net/file/User/osaka.php">大阪府</option>
            ...
            <input type=button onClick="top.location.href=prefecture.value" value="検索" class="btn-flat-simple">
        </form>
        </div>
    </div>    
